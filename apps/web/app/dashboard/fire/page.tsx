        ...
        <div className="flex h-screen bg-background text-foreground overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <main className="flex-1 overflow-y-auto bg-background/50 relative scrollbar-thin scrollbar-thumb-accent/10">
                    ...
                    {/* Header */}
                    <header className="px-6 md:px-10 py-12 md:py-16 border-b border-white/5 relative bg-[radial-gradient(circle_at_10%_20%,rgba(212,175,55,0.03)_0%,transparent_50%)] overflow-hidden">
                        ...
                        <div className="max-w-7xl mx-auto relative z-10">
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                                <div>
                                    ...
                                    <h1 className="text-4xl md:text-7xl font-black font-barlow-condensed tracking-tighter leading-none uppercase">
                                        EXIT <span className="text-accent underline decoration-accent/30 underline-offset-8">PLANNER</span>
                                    </h1>
                                    <p className="text-muted-foreground font-bold tracking-widest text-[9px] md:text-xs mt-6 max-w-xl opacity-60 uppercase leading-relaxed">
                                        Financial Independence, Retire Early. Calibrating inflation-adjusted escape velocity for your capital.
                                    </p>
                                </div>
                                <div className="flex gap-4">
                                    <div className="p-4 bg-white/5 border border-white/5 rounded-2xl">
                                        <p className="text-[8px] font-black tracking-widest text-muted-foreground uppercase mb-1">Status</p>
                                        <div className="flex items-center gap-2">
                                            <span className="flex h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                                            <span className="text-xs font-black uppercase tracking-widest">Calculations Live</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="px-6 md:px-10 py-12">
                        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 pb-32">

                            {/* Left: Inputs Column */}
                            <div className="lg:col-span-4 space-y-8">
                                <div className="glass-panel border border-white/5 rounded-3xl p-8 space-y-8 shadow-2xl">
                                    <div className="flex items-center gap-3 text-accent mb-2">
                                        <Calendar size={16} />
                                        <h3 className="text-xs font-black tracking-[0.2em] uppercase">Life Metrics</h3>
                                    </div>

                                    {/* Age Sliders */}
                                    <div className="space-y-6">
                                        <div>
                                            <div className="flex justify-between mb-3 px-1 text-[10px] font-black text-muted-foreground uppercase tracking-widest">
                                    ...
                                    <div className="flex items-center gap-3 text-accent mb-2">
                                        <Wallet size={16} />
                                        <h3 className="text-xs font-black tracking-[0.2em] uppercase">Capital Flow</h3>
                                    </div>

                                    {/* Financial Inputs */}
                                    <div className="space-y-6">
                                        <div>
                                            <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-3">Current Monthly Expenses</p>
                                            <div className="relative">
                                                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-accent text-sm font-black">₹</span>
                                                <input
                                                    type="number"
                                                    value={monthlyExpenses}
                                                    onChange={(e) => setMonthlyExpenses(parseInt(e.target.value) || 0)}
                                                    className="w-full bg-background/50 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm font-bold focus:border-accent/40 outline-none transition-all"
                                                />
                                            </div>
                                        </div>
                                        <div>
                                            <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-3">Existing Corpus (Savings)</p>
                                            <div className="relative">
                                                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-accent text-sm font-black">₹</span>
                                                <input
                                                    type="number"
                                    ...
                                    <div className="grid grid-cols-2 gap-6 pt-2">
                                        <div>
                                            <p className="text-[8px] font-black text-muted-foreground uppercase tracking-widest mb-2 opacity-60">Inflation (%)</p>
                                            <input
                                                type="number" value={inflation} onChange={e => setInflation(Number(e.target.value))}
                                                className="w-full bg-background/50 border border-white/10 rounded-xl px-4 py-2.5 text-xs font-bold focus:border-accent/40 outline-none"
                                            />
                                        </div>
                                        <div>
                                            <p className="text-[8px] font-black text-muted-foreground uppercase tracking-widest mb-2 opacity-60">Return (%)</p>
                                            <input
                                ...
                                <div className="p-6 bg-accent/5 border border-accent/20 rounded-3xl relative overflow-hidden group">
                                    ...
                                    <h4 className="text-[10px] font-black tracking-widest uppercase mb-4 text-accent">Protocol Alert</h4>
                                    <p className="text-[11px] text-muted-foreground uppercase leading-relaxed font-bold tracking-wider">
                            ...
                            <div className="lg:col-span-8 space-y-10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div className="glass-panel border border-white/5 rounded-[32px] p-8 hover:border-accent/20 transition-all group">
                                        <p className="text-[9px] font-black tracking-widest text-muted-foreground uppercase mb-4">Target FIRE Corpus</p>
                                        <div className="flex items-baseline gap-2">
                                            <span className="text-3xl md:text-4xl font-black font-barlow-condensed tracking-tight text-foreground group-hover:text-accent transition-colors">
                                                {formatCurrency(results.targetCorpus)}
                                            </span>
                                        </div>
                                        <p className="text-[8px] text-accent/50 font-black tracking-widest uppercase mt-4">Required for {withdrawalRate}% SWR</p>
                                    </div>

                                    <div className="glass-panel border border-white/5 rounded-[32px] p-8 hover:border-accent/20 transition-all group">
                                        <p className="text-[9px] font-black tracking-widest text-muted-foreground uppercase mb-4">Monthly SIP Protocol</p>
                                        <div className="flex items-baseline gap-2">
                                            <span className="text-3xl md:text-4xl font-black font-barlow-condensed tracking-tight text-foreground group-hover:text-emerald-400 transition-colors">
                                                {formatCurrency(results.sipRequired)}
                                            </span>
                                        </div>
                                        <p className="text-[8px] text-muted-foreground/50 font-black tracking-widest uppercase mt-4">Starting immediately</p>
                                    </div>

                                    <div className="glass-panel border border-white/5 rounded-[32px] p-8 hover:border-accent/20 transition-all group">
                                        <p className="text-[9px] font-black tracking-widest text-muted-foreground uppercase mb-4">Retirement Expenses</p>
                                        <div className="flex items-baseline gap-2 text-red-500/80">
                                            <span className="text-3xl md:text-4xl font-black font-barlow-condensed tracking-tight">
                                                {formatCurrency(results.futureMonthlyExpenses)}
                                            </span>
                                        </div>
                                        <p className="text-[8px] text-muted-foreground/50 font-black tracking-widest uppercase mt-4">Inflation Adjusted</p>
                                    </div>
                                </div>

                                {/* Main Trajectory Chart */}
                                <div className="glass-panel border border-white/5 rounded-[40px] p-8 md:p-10 shadow-3xl">
                                    <div className="flex items-center justify-between mb-12">
                                        <div>
                                            <h3 className="text-xs font-black tracking-[0.3em] text-muted-foreground uppercase mb-1">CAPITAL TRAJECTORY</h3>
                                            <p className="text-[9px] font-bold text-accent tracking-widest uppercase">Wealth Projection Archive</p>
                                        </div>
                                        <div className="flex gap-4">
                                            <div className="flex items-center gap-2">
                                                <div className="w-2 h-2 rounded-full bg-accent shadow-[0_0_8px_rgba(212,175,55,0.5)]" />
                                                <span className="text-[8px] font-black tracking-widest uppercase opacity-40">Portfolio Value</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-12 pt-8 border-t border-white/5 grid grid-cols-1 md:grid-cols-3 gap-8">
                                        <div className="flex items-start gap-4">
                                            <div className="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center border border-emerald-500/20 text-emerald-400 shrink-0">
                                                <PieChartIcon size={18} />
                                            </div>
                                            <div>
                                                <p className="text-[10px] font-black tracking-widest text-foreground uppercase mb-1">Asset Shift</p>
                                        ...
                                        <div className="flex items-start gap-4">
                                            <div className="w-10 h-10 bg-accent/10 rounded-xl flex items-center justify-center border border-accent/20 text-accent shrink-0">
                                                <Activity size={18} />
                                            </div>
                                            <div>
                                                <p className="text-[10px] font-black tracking-widest text-foreground uppercase mb-1">Stability Check</p>
                                                <p className="text-[9px] text-muted-foreground uppercase leading-relaxed font-bold">
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black tracking-widest text-foreground uppercase mb-1">Inflation Hedge</p>
                                                <p className="text-[9px] text-muted-foreground uppercase leading-relaxed font-bold">
                                ...
                                <div className="flex flex-col sm:flex-row gap-6 pt-4 no-print">
                                    <button 
                                        ...
                                        disabled={isSaving}
                                        className={`flex-1 py-5 ${saveSuccess ? 'bg-emerald-500' : 'bg-accent'} text-background font-black text-xs uppercase tracking-[0.3em] rounded-2xl hover:scale-[1.02] shadow-2xl transition-all active:scale-95 flex items-center justify-center gap-3 disabled:opacity-50`}
                                    >
                                        {isSaving ? (
                                    ...
                                    <button 
                                        ...
                                        className="flex-1 py-5 bg-secondary/30 border border-white/5 text-foreground font-black text-xs uppercase tracking-[0.3em] rounded-2xl hover:bg-secondary/50 transition-all flex items-center justify-center gap-3"
                                    >
                                        <ArrowRight size={18} />
