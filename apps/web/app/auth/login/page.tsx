    ...
    return (
        <div className="w-full max-w-md mx-auto relative z-10 flex flex-col justify-center">
            ...
            <button 
                ...
                onClick={() => googleLogin()}
                disabled={loading}
                className="w-full py-3 px-4 border border-white/5 rounded-sm text-white/40 hover:text-white hover:bg-white/[0.02] transition-all flex items-center justify-center gap-2 mb-8 text-[10px] font-mono tracking-widest uppercase"
            >
                {loading ? (
